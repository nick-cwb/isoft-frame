      ...
      <Col span="24">
        <Row>
          <Col span="6" style="height:550px;position:relative">
            ...
            <Button type="success" v-hasPermission="'menu_add'" style="position:absolute;top:5px;right:100px"  @click="addButton">新增</Button>
            <Button type="error" v-hasPermission="'menu_del'" style="position:absolute;top:5px;right:30px" @click="delButton">删除</Button>
          </Col>
          <Col span="1">
            ...
            <Tabs value="tabSelectedMenu" type="card">
              <TabPane label="菜单信息" name="tabSelectedMenu">
                ...
                >
                  ...
                  <FormItem label="父级菜单">
                    <Input v-model="formItemMenu.parentName" disabled></Input>
                  </FormItem>
                  ...
                  <FormItem label="排编号" prop="menuOrder">
...
<script>
import { getTree, getInfoById } from '@/libs/tree'
  ...
  methods: {
    ...
    getMenuBtns (query) {
      if (this.selectedMenu.id) {
        query.menuCode = this.selectedMenu.menuCode
      }
      ...
      this.$refs[name].validate(valid => {
        if (valid) {
          ...
          if (this.formItemMenu.mode === 'edit') {
            ...
            this.formItem.name = this.formItem.menuCode
    ...
    select (value) {
      ...
      this.formItemMenu.parentId = this.selectedMenu.attr.id
